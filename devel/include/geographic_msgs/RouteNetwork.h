...
struct RouteNetwork_
{
  ...
  _points_type points;
   ...
   typedef std::vector< ::geographic_msgs::RouteSegment_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::geographic_msgs::RouteSegment_<ContainerAllocator> >> _segments_type;
