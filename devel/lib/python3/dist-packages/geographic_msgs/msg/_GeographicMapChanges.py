...
"""autogenerated by genpy from geographic_msgs/GeographicMapChanges.msg. Do not edit."""
import codecs
import sys
...
class GeographicMapChanges(genpy.Message):
  _md5sum = "4fd027f54298203ec12aa1c4b20e6cb8"
  _type = "geographic_msgs/GeographicMapChanges"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# A list of geographic map changes.
...
"""
  __slots__ = ['header','diffs','deletes']
  _slot_types = ['std_msgs/Header','geographic_msgs/GeographicMap','uuid_msgs/UniqueID[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GeographicMapChanges, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.diffs is None:
        self.diffs = geographic_msgs.msg.GeographicMap()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_3I().pack(_x.diffs.header.seq, _x.diffs.header.stamp.secs, _x.diffs.header.stamp.nsecs))
      _x = self.diffs.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.diffs.id.uuid
      ...
      _x = self
      buff.write(_get_struct_6d().pack(_x.diffs.bounds.min_pt.latitude, _x.diffs.bounds.min_pt.longitude, _x.diffs.bounds.min_pt.altitude, _x.diffs.bounds.max_pt.latitude, _x.diffs.bounds.max_pt.longitude, _x.diffs.bounds.max_pt.altitude))
      length = len(self.diffs.points)
      buff.write(_struct_I.pack(length))
      for val1 in self.diffs.points:
        _v1 = val1.id
        _x = _v1.uuid
        # - if encoded as a list instead, serialize as bytes instead of string
        if type(_x) in [list, tuple]:
        ...
        for val2 in val1.props:
          ...
          if python3 or type(_x) == unicode:
            ...
            length = len(_x)
          buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.diffs.features)
      buff.write(_struct_I.pack(length))
      for val1 in self.diffs.features:
        _v3 = val1.id
        _x = _v3.uuid
        # - if encoded as a list instead, serialize as bytes instead of string
        if type(_x) in [list, tuple]:
        ...
        for val2 in val1.props:
          ...
          if python3 or type(_x) == unicode:
            ...
            length = len(_x)
          buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.diffs.props)
      buff.write(_struct_I.pack(length))
      for val1 in self.diffs.props:
        _x = val1.key
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.deletes)
      buff.write(_struct_I.pack(length))
      for val1 in self.deletes:
        _x = val1.uuid
        # - if encoded as a list instead, serialize as bytes instead of string
        if type(_x) in [list, tuple]:
          buff.write(_get_struct_16B().pack(*_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.diffs.header.seq, _x.diffs.header.stamp.secs, _x.diffs.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.diffs.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.diffs.header.frame_id = str[start:end]
      start = end
      end += 16
      self.diffs.id.uuid = str[start:end]
      _x = self
      start = end
      end += 48
      (_x.diffs.bounds.min_pt.latitude, _x.diffs.bounds.min_pt.longitude, _x.diffs.bounds.min_pt.altitude, _x.diffs.bounds.max_pt.latitude, _x.diffs.bounds.max_pt.longitude, _x.diffs.bounds.max_pt.altitude,) = _get_struct_6d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.diffs.points = []
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          if python3:
            ...
            val2.value = str[start:end]
          val1.props.append(val2)
        self.diffs.features.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.diffs.props = []
