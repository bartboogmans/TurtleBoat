...
struct MapFeature_
{
  ...
  _id_type id;
   ...
   typedef std::vector< ::uuid_msgs::UniqueID_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::uuid_msgs::UniqueID_<ContainerAllocator> >> _components_type;
