...
struct GeoPath_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::geographic_msgs::GeoPoseStamped_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::geographic_msgs::GeoPoseStamped_<ContainerAllocator> >> _poses_type;
  _poses_type poses;
