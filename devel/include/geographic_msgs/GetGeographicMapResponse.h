...
bool operator==(const ::geographic_msgs::GetGeographicMapResponse_<ContainerAllocator1> & lhs, const ::geographic_msgs::GetGeographicMapResponse_<ContainerAllocator2> & rhs)
{
